...
# Calculate % of positives
percent_positive <- (plot_aggregated$positives / (plot_aggregated$positives + plot_aggregated$negatives)) * 100

# Plot scatter graph
ggplot(plot_aggregated, aes(x = abundance, y = percent_positive, label = associatedTaxa, color = associatedTaxa)) +
  geom_point() +
