...
![Example of included data, individual level data (one row per rodent) is also accepted. This table is to demonstrate resolution, **data do not have to match this format**.](../figures/data_example.png)
